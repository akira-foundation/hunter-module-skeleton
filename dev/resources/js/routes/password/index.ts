...
* @see app/Http/Controllers/UserPasswordController.php:24
...
* @see app/Http/Controllers/UserPasswordController.php:32
...
* @see app/Http/Controllers/UserPasswordController.php:49
...
* @see app/Http/Controllers/UserPasswordController.php:54
* @route '/settings/password'
*/
